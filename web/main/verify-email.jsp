                    ...
                    <div class="col-lg-5 col-md-8">
                        ...
                        <div class="card login-page bg-white shadow mt-4 rounded border-0">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p class="text-muted">You need to verify the email used for the registration. We have sent a link to your email.</p>
                                        <p class="text-muted">Click <a href="/main/login.jsp" class="text-dark h6 mb-0">here</a> to back to login page, or click the link in your email to proceed.</p>
                                    </div>
                                </div>
                            </div>
                        </div><!---->
