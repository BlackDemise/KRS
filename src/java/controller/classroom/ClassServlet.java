...
@WebServlet(name = "ClassServlet", urlPatterns = {"/class", "/class/add", "/class/toggle", "/class/update", "/class/uploadExcel"})
...
public class ClassServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (ACTION) {
            case "/class" -> handleAllClasses(request, response);
            case "/class/add" -> handleAddGet(request, response);
            case "/class/update" -> handleUpdateGet(request, response);
            case "/class/toggle" -> handleTogglePost(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        final String ACTION = request.getServletPath();
        switch (ACTION) {
            case "/class/add" -> handleAddPost(request, response);
            case "/class/update" -> handleUpdatePost(request, response);
            case "/class/uploadExcel" -> uploadExcel(request, response);
        }
    }
